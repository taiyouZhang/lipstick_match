...
def crop(source,pos):
      ...
      # save the image
      cv2.imwrite("../result/Mouth1.jpg", region)
      ...
      # save the image
      cv2.imwrite("../result/Mouth2.jpg", region)
...
if __name__ == "__main__": 
      img = cv2.imread("../data/pic/test.png")
      #copy the input image for the later crop#
      img_clone = np.copy(img)
      cv2.imwrite("../result/source.jpg",img_clone)
      #save the lip position to pos array#
      pos=np.zeros((3,2), dtype=int)
      result=detect_mouth(img,pos)
      cv2.imwrite("../result/source2.jpg",result)
      #crop the lip areas#
      source = cv2.imread("../result/source.jpg")
      crop(source,pos)
      # show the result
